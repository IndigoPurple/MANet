...
legend_list = {'EWD-SRNet', 'WS-SRNet-j', 'WS-SRNet-p'};
color_list = {[228,26,28]/255.0, [55,126,184]/255.0,  [77,175,74]/255.0};

% dataset_name = 'LF_dataset_x8/';
% filename = 'ablation_X8.pdf';
% ymin = 36; ymax = 41.5;

dataset_name = 'Flower_dataset_x8/';
filename = 'ablation_X8_2.pdf';
ymin = 34; ymax = 40.5;
%% x4 SR
