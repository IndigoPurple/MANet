                ...
                scipy.io.savemat(visualization_path+'data_'+str(batch_index*config.batch_size_test), 
                    {
                        ...
                        'attention_1_1':attention1.data.cpu().numpy()[:,0,:,:,:],
                        'attention_1_2':attention1.data.cpu().numpy()[:,1,:,:,:],
                        'attention_1_3':attention1.data.cpu().numpy()[:,2,:,:,:],
                        'attention_1_4':attention1.data.cpu().numpy()[:,3,:,:,:]
                    },
                    do_compression=True
                )
...
def get_model_flags_v1():
    ...
    ''' config '''
    parser.add_argument('--model_name', type = str, default='multi_flow_complex', help='model_name')
    ...
    parser.add_argument('--batch_size_train', type = int, default=1, help='The batch size for training')
    parser.add_argument('--batch_size_test', type = int, default=1, help='The batch size for training')
    ...
    parser.add_argument('--visualization_folder_test', type = str, default='visualization_test', help= 'visualization_folder folder')
    parser.add_argument('--visualization_folder_train', type = str, default='visualization_train', help= 'visualization_folder folder')
...
if __name__ == '__main__':
    ...
    if dataset_name=='denoise':
        ...
        dataset_train = VimeoDataset(data_path_corrupted, data_path_clean, data_list_file_train, frame_window_size=3, transform=composed_train, small_factor=3)
        ...
        dataset_test = VimeoDataset(data_path_corrupted, data_path_clean, data_list_file_test, frame_window_size=3, transform=composed_test, small_factor=3)
