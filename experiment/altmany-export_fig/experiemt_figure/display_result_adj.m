...
% imgpath = '../Flower_dataset_x8/LR(1,1)-REF(0,0)'; i = 34;   number = 101;
% imgpath = '../LF_dataset_x8/LR(3,3)-REF(0,0)'; i = 1;     number = 102;
imgpath = '../LF_dataset_x8/LR(1,1)-REF(0,0)'; i = 169;    number = 103;
