    ...
    with torch.no_grad():
        ...
        for batch_index, batched_sample in enumerate(dataloader_test):
            ...
            if True:
                ...
                save_batchimages(img1.data.cpu().numpy(), visualization_path+'current_', count=batch_index*config.batch_size_test)
...
def get_model_flags_v1():
    ...
    parser.add_argument('--test_snapshot_file', type = str, default='11.pth', help= 'snapshot filename')
